...
public class AxisSettings extends Observable implements SettingOwner
{
	...
	public AxisSettings(String name, boolean isDomain, Graph graph)
	{
		...
		headingFont = new FontColorSetting("heading font", new FontColorPair(new Font("SansSerif", Font.PLAIN, 12), Color.black),
				"The font for this axis' heading.", this, true);
		numberFont = new FontColorSetting("numbering font", new FontColorPair(new Font("SansSerif", Font.PLAIN, 12), Color.black),
		...
		gridInterval = new DoubleSetting("gridline interval", new Double(0.2), "The interval between gridlines", this, false,
				new RangeConstraint(0, Double.POSITIVE_INFINITY, false, true));
		...
		logStyle = new ChoiceSetting("logarithmic number style", logStyleChoices, logStyleChoices[1],
				"Should the style of the logarithmic scale show the actual values, or the base with the exponent.", this, false);
