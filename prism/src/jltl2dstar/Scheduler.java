...
public class Scheduler
{
	...
	public static class Tree_Start extends Tree
	{
		...
		public void generateTree()
		{
			...
			if (_options.automata == Options_LTL2DRA.AutomataType.RABIN || _options.automata == Options_LTL2DRA.AutomataType.RABIN_AND_STREETT) {
				rabin = new Tree_Rabin(_ltl, _apset, _options, _sched);
			}

			if (_options.automata == Options_LTL2DRA.AutomataType.STREETT || _options.automata == Options_LTL2DRA.AutomataType.RABIN_AND_STREETT) {
	...
	public void flagStatNBA(boolean value)
	{
		_stat_NBA = value;
	}
