...
public class DoubleVector
{
	...
	public JDDNode getBDDFromInterval(RelOp relOp, double bound, JDDVars vars, ODDNode odd)
	{
		...
		switch (relOp) {
		case GEQ:
			sol = JDD.ptrToNode(DV_BDDGreaterThanEquals(v, bound, vars.array(), vars.n(), odd.ptr()));
			break;
		case GT:
			sol = JDD.ptrToNode(DV_BDDGreaterThan(v, bound, vars.array(), vars.n(), odd.ptr()));
			break;
		case LEQ:
			sol = JDD.ptrToNode(DV_BDDLessThanEquals(v, bound, vars.array(), vars.n(), odd.ptr()));
			break;
		case LT:
			sol = JDD.ptrToNode(DV_BDDLessThan(v, bound, vars.array(), vars.n(), odd.ptr()));
			break;
		default:
			// Don't handle
		}
	...
	public JDDNode getBDDFromInterval(double lo, double hi, JDDVars vars, ODDNode odd)
	{
		...
		sol = JDD.ptrToNode(DV_BDDInterval(v, lo, hi, vars.array(), vars.n(), odd.ptr()));
	...
	public JDDNode getBDDFromCloseValueAbs(double value, double epsilon, JDDVars vars, ODDNode odd)
	{
		...
		sol = JDD.ptrToNode(DV_BDDCloseValueAbs(v, value, epsilon, vars.array(), vars.n(), odd.ptr()));
	...
	public JDDNode getBDDFromCloseValueRel(double value, double epsilon, JDDVars vars, ODDNode odd)
	{
		...
		sol = JDD.ptrToNode(DV_BDDCloseValueRel(v, value, epsilon, vars.array(), vars.n(), odd.ptr()));
	...
	public JDDNode convertToMTBDD(JDDVars vars, ODDNode odd)
	{
		...
		sol = JDD.ptrToNode(DV_ConvertToMTBDD(v, vars.array(), vars.n(), odd.ptr()));
