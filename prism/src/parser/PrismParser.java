...
public class PrismParser implements PrismParserConstants
{
	...
	public static void main(String[] args)
	{
		...
		try {
			...
			System.out.println("Error in " + src + ": " + e.getMessage() + ".");
			System.exit(1);
	...
	public ModulesFile parseModulesFile(InputStream str) throws PrismLangException
	{
		return parseModulesFile(str, null);
	}
	...
	*/
	public static String getPrecedingCommentBlock(Token firstToken)
	{
		...
		if (t.specialToken != null
				&& !(t.specialToken.kind == PrismParserConstants.WHITESPACE && t.specialToken.image.matches("[\u005c\u005cn\u005c\u005cr]*"))) {
	...
	*/
	...
	static final public PropertiesFile PropertiesFile() throws ParseException, PrismLangException
	{
		...
		jj_consume_token(0);
		pf.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return pf;
		}
	...
	static final public Property Property() throws ParseException
	{
		...
		prop.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return prop;
		}
	...
	static final public void LabelDef(LabelList labelList) throws ParseException, PrismLangException
	{
		...
		if (jj_2_3(2147483647)) {
			...
			{
				if (true)
					throw new PrismLangException("Label names must be enclosed in double-quotes", name);
			}
		} else {
			jj_consume_token(-1);
			throw new ParseException();
	...
	static final public Declaration Declaration() throws ParseException
	{
		...
		jj_consume_token(SEMICOLON);
		decl.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return decl;
		}
	...
	static final public DeclarationType DeclarationVarType() throws ParseException
	{
		...
		declType.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return declType;
		}
	...
	static final public Module Module() throws ParseException
	{
		...
		module.setPosition(begin, getToken(0));
		module.setNameASTElement(name);
		{
			if ("" != null)
				return module;
		}
	...
	static final public Command Command() throws ParseException
	{
		...
		jj_consume_token(SEMICOLON);
		comm.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return comm;
		}
	...
	static final public Updates Updates() throws ParseException
	{
		...
		updates.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return updates;
		}
	...
	static final public Update Update() throws ParseException
	{
		...
		update.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return update;
		}
	...
	static final public RenamedModule RenamedModule() throws ParseException
	{
		...
		jj_consume_token(RBRACKET);
		jj_consume_token(ENDMODULE);
		rm.setPosition(begin, getToken(0));
		rm.setNameASTElement(name);
		rm.setBaseModuleASTElement(base);
		{
			if ("" != null)
				return rm;
		}
	...
	static final public RewardStruct RewardStruct() throws ParseException
	{
		...
		label_11: while (true) {
			...
			jj_consume_token(SEMICOLON);
			rsi = new RewardStructItem(s, guard, value);
			rsi.setPosition(begin2, getToken(0));
			rs.addItem(rsi);
		}
		jj_consume_token(ENDREWARDS);
		rs.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return rs;
		}
	...
	static final public SystemDefn SystemParallel() throws ParseException
	{
		...
		if (jj_2_10(2147483647)) {
			par = new SystemParallel();
			par.setOperand1(sys1);
			jj_consume_token(OR);
			jj_consume_token(LBRACKET);
			s = Identifier();
			par.addAction(s);
	...
	static final public SystemDefn SystemHideRename() throws ParseException
	{
		...
		sys.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return sys;
		}
	...
	static final public Expression ExpressionTemporalBinary(boolean prop, boolean pathprop) throws ParseException
	{
		...
		case W: {
			...
			exprTemp = new ExpressionTemporal();
			exprTemp.setOperand1(ret);
			switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
			case U: {
				jj_consume_token(U);
			...
			exprTemp.setPosition(begin, getToken(0));
			ret = exprTemp;
			break;
		}
		default:
	...
	static final public Expression ExpressionITE(boolean prop, boolean pathprop) throws ParseException
	{
		...
		case QMARK: {
			...
			ret = new ExpressionITE(ret, left, right);
	...
	static final public Expression ExpressionImplies(boolean prop, boolean pathprop) throws ParseException
	{
		...
		label_18: while (true) {
			...
			ret = new ExpressionBinaryOp(ExpressionBinaryOp.IMPLIES, ret, expr);
			ret.setPosition(begin, getToken(0));
		}
		{
			if ("" != null)
	...
	static final public Expression ExpressionIff(boolean prop, boolean pathprop) throws ParseException
	{
		...
		label_19: while (true) {
			...
			ret = new ExpressionBinaryOp(ExpressionBinaryOp.IFF, ret, expr);
			ret.setPosition(begin, getToken(0));
		}
		{
			if ("" != null)
	...
	static final public Expression ExpressionOr(boolean prop, boolean pathprop) throws ParseException
	{
		...
		label_20: while (true) {
			...
			ret = new ExpressionBinaryOp(ExpressionBinaryOp.OR, ret, expr);
			ret.setPosition(begin, getToken(0));
		}
		{
			if ("" != null)
	...
	static final public Expression ExpressionAnd(boolean prop, boolean pathprop) throws ParseException
	{
		...
		label_21: while (true) {
			...
			ret = new ExpressionBinaryOp(ExpressionBinaryOp.AND, ret, expr);
			ret.setPosition(begin, getToken(0));
		}
		{
			if ("" != null)
	...
	static final public Expression ExpressionNot(boolean prop, boolean pathprop) throws ParseException
	{
		...
		case NOT: {
			...
			expr = ExpressionNot(prop, pathprop);
			ret = new ExpressionUnaryOp(ExpressionUnaryOp.NOT, expr);
			ret.setPosition(begin, getToken(0));
			break;
		}
		case A:
	...
	static final public Expression ExpressionEquality(boolean prop, boolean pathprop) throws ParseException
	{
		...
		label_22: while (true) {
			...
			ret = new ExpressionBinaryOp(op, ret, expr);
			ret.setPosition(begin, getToken(0));
		}
		{
			if ("" != null)
	...
	static final public Expression ExpressionUnaryMinus(boolean prop, boolean pathprop) throws ParseException
	{
		...
		case MINUS: {
			...
			expr = ExpressionUnaryMinus(prop, pathprop);
			ret = new ExpressionUnaryOp(ExpressionUnaryOp.MINUS, expr);
			ret.setPosition(begin, getToken(0));
			break;
		}
		case A:
	...
	static final public Expression ExpressionFuncMinMax(boolean prop, boolean pathprop) throws ParseException
	{
		...
		jj_consume_token(RPARENTH);
		func.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return func;
		}
	...
	static final public Expression ExpressionParenth(boolean prop, boolean pathprop) throws ParseException
	{
		...
		expr = Expression(prop, pathprop);
		jj_consume_token(RPARENTH);
		ret = new ExpressionUnaryOp(ExpressionUnaryOp.PARENTH, expr);
		ret.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return ret;
	...
	static final public Filter Filter() throws ParseException
	{
		...
		filter.setPosition(begin, getToken(0));
		{
			if ("" != null)
				return filter;
		}
		...
		if (jj_2_17(2147483647)) {
			...
			default:
				...
				if (jj_2_18(2147483647)) {
					...
					jj_consume_token(LE);
					expr = Expression(false, false);
					exprTemp = new ExpressionTemporal(ExpressionTemporal.R_C, null, null);
					...
					case I: {
						...
						jj_consume_token(EQ);
						expr = Expression(false, false);
						exprTemp = new ExpressionTemporal(ExpressionTemporal.R_I, null, null);
						exprTemp.setUpperBound(expr);
						ret = exprTemp;
						break;
					}
	...
	static final public Expression ExpressionFilter(boolean prop, boolean pathprop) throws ParseException
	{
		...
		jj_consume_token(RPARENTH);
		expr = new ExpressionFilter(op, expr2, filter);
	...
	{
		if (jj_scan_token(DLBRACKET))
			return true;
		if (jj_3R_205())
			return true;
		if (jj_scan_token(DRBRACKET))
			return true;
		return false;
	}
	...
	{
		if (jj_scan_token(DLT))
			return true;
		if (jj_3R_205())
			return true;
		if (jj_scan_token(DGT))
			return true;
		return false;
	}
	...
	{
		jj_la1_0 = new int[] { 0x514404c0, 0x504404c0, 0x1000000, 0xb01a0848, 0x0, 0xb01a0848, 0xb01a0848, 0x0, 0xb01a0848, 0x400, 0x40000000, 0x80, 0x40000480,
				0x8000210, 0x8000210, 0x0, 0x40, 0x0, 0x1000000, 0x8000030, 0x0, 0x2000000, 0x0, 0x0, 0x0, 0xa0ba0808, 0x0, 0x0, 0x0, 0xa0ba0808, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa00000, 0x0, 0xa0ba0808, 0xa0ba0808, 0xa0ba0808, 0xa0ba0808, 0xa0ba0808, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xa01a0808, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa01a0808, 0xa01a0808, 0x0, 0xa0000000, 0xa0000000, 0x0, 0x20000, 0x0, 0xa0000000, 0x0, 0x0, 0x0,
				0xa0000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa0000000, 0x0, 0x0, 0xa0ba0808, 0xa0ba0808, 0x0, 0x0, 0xa4ba0908, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x1000000, 0xa0000000, 0x0, 0xa0000000, 0x0, 0x0, 0x0, };
	}

	private static void jj_la1_init_1()
	{
		jj_la1_1 = new int[] { 0x187c5, 0x83c4, 0x10401, 0x40127ab8, 0x8000000, 0x40127ab8, 0x40127ab8, 0x8000000, 0x40127ab8, 0x40, 0x4, 0x8000, 0x8144, 0x0,
				0x0, 0x280, 0x280, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4012783a, 0x200000, 0x40020000, 0x10000000, 0x4012783a, 0x0, 0x0, 0x10000000, 0x0,
				0x10000000, 0x10000000, 0x0, 0x40000000, 0xc2000, 0x0, 0xc2000, 0x2, 0x0, 0x4012783a, 0x4012783a, 0x4012783a, 0x4012783a, 0x4012783a, 0x0, 0x0,
				0x800000, 0x1000000, 0x400000, 0x200000, 0x40127838, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40027838, 0x40027838, 0x40000000, 0x0, 0x0, 0x10000000,
				0x20000, 0x40000000, 0x0, 0x38, 0x0, 0x0, 0x0, 0x40000000, 0x40000000, 0x0, 0x40000000, 0x0, 0x0, 0x3800, 0x0, 0x4012783a, 0x4012783a, 0x0,
				0x4000, 0x4012783a, 0x0, 0x3838, 0x40003838, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x600000, 0x10000000, 0x0, 0x0, 0x0, 0x4000000, };
	}

	private static void jj_la1_init_2()
	{
		jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x2e08404, 0x0, 0x2e08404, 0x2e08404, 0x0, 0x2e08404, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40, 0x0, 0x1,
				0x2000000, 0x0, 0x1, 0x2000000, 0x4000, 0x2e08404, 0x0, 0x0, 0x0, 0x2e08405, 0x2000000, 0x1, 0x0, 0x20010, 0x0, 0x0, 0x20010, 0x2200000, 0x0,
				0x3341, 0x0, 0x0, 0x3341, 0x2e08404, 0x2e08404, 0x2e08404, 0x2e08404, 0x2e08404, 0x3341, 0x100000, 0x0, 0x0, 0x0, 0x0, 0x2e08404, 0xc0, 0x3300,
				0xc000, 0xc000, 0x30000, 0x30000, 0x2e08404, 0x2e00404, 0x0, 0x0, 0x2000000, 0x0, 0xc00000, 0x0, 0x3340, 0x0, 0x10, 0x10, 0x0, 0x0, 0x3340,
				0x10, 0x0, 0x10, 0x3340, 0x0, 0x10, 0x2e08404, 0x2e08404, 0x20000, 0x0, 0x2e08404, 0x404, 0x0, 0x0, 0x0, 0x2400000, 0x10000, 0x2400000,
