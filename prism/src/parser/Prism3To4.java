...
public class Prism3To4 implements Prism3To4Constants
{
	public static void main(String[] args) throws ParseException
	{
		try {
			Prism3To4 p;
			if (args.length > 0) {
				p = new Prism3To4(new FileInputStream(args[0]));
			} else {
				p = new Prism3To4(System.in);
			}
			p.ModulesFileOrPropertiesFile();
		} catch (TokenMgrError e) {
			System.err.println("Syntax error" + (args.length > 0 ? " in " + args[0] : "") + ": " + e.getMessage());
			System.exit(1);
		} catch (ParseException e) {
			System.err.println("Error" + (args.length > 0 ? " in " + args[0] : "") + ": " + e.getMessage());
			System.exit(1);
	...
	private static void insertTokenBeforeNext(Token t, String s)
	{
		...
		tNew.image = s;
		tNew.specialToken = t.next.specialToken;
		t.next.specialToken = null;
		tNew.next = t.next;
		t.next = tNew;
	}
	...
	static final public void ModulesFileOrPropertiesFile() throws ParseException
	{
		...
		while (ptr != null) {
			if (ptr.specialToken != null) {
				ptr2 = ptr;
				while (ptr2.specialToken != null)
					ptr2 = ptr2.specialToken;
				while (ptr2 != null) {
					System.out.print(ptr2.image);
					ptr2 = ptr2.next;
				}
			}
	...
	static final public void ExpressionRelOpRange() throws ParseException
	{
		...
		if (jj_2_150(2147483647)) {
			...
			if (thisIsARange) {
				t0.next = getToken(1);
				insertTokenBeforeNext(t0, newExpr);
			}
	...
	{
		if (jj_scan_token(NONDETERMINISTIC))
			return true;
		return false;
	}
	...
	{
		if (jj_scan_token(PROBABILISTIC))
			return true;
		return false;
	}
